...
<head>
  ...
  <link rel="stylesheet" href="../assets/css/stylecontinuerading.css">
</head>
<body>
...
<div class="page-section">
  <div class="container">
    <div class="row justify-content-center">
      ...
      <article class="blog-entry" style="text-align:center;">
            <div class="entry-header">
            <div class="post-title webchat">{{ $Post->title }}</div>
              <div class="post-thumbnail">
                <img src="{{ asset('postimg') }}/{{ $Post->image }}" alt="">
              </div>
             
            </div>
           <div class="entry-content" style="background-color:beige; border-radius:10px">
              <p>{{ $Post->body }}</p>
            </div>
