  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarToggler">
      <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="blog.html">Sign In</a>
        </li>
        <li class="nav-item active">
        ...
        <!-- @foreach( $Post as $User)
          <article class="blog-entry">
            ...
            <div class="entry-meta mb-2">
              ...
              <div class="meta-item">
                <div class="icon">
                 <a href="/signup/{{ $Post->id }}" style="color:white; text-decoration:none"><span class="mai-chatbubble-ellipses"></span></a> 
...
<div class="col-md-12">
  ...
  <h1>Add Post</h1>
      ...
      <form action="{{url('addpost/'.$Post->id)}}" method="POST" class="mt-5" enctype="multipart/form-data">
        {{ csrf_field() }}
